...
- Added admin ACL checks to the module's controllers
- Stopped leaking API credentials and customer data in the debug export
...
## [1.5.1](https://github.com/packlink-dev/magento2_module/compare/v1.5.0...1.5.1)
### Changed
- Fix the price display on the order details page

## [1.5.0](https://github.com/packlink-dev/magento2_module/compare/v1.4.3...1.5.0)
### Changed
