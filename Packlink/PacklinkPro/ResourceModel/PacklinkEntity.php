...
use Packlink\PacklinkPro\IntegrationCore\Infrastructure\ORM\QueryFilter\QueryCondition;
 ...
 */
class PacklinkEntity extends AbstractDb
{
    /**
    ...
    /**
     * Selects all records from Packlink entity table.
     *
     * @return array Packlink entity records.
     *
    ...
    /**
     * Performs a select query over a specific type of entity with given Packlink query filter.
     *
    ...
    /**
     * Inserts a new record in Packlink entity table.
     *
     * @param Entity $entity Packlink entity.
     *
    ...
    /**
     * Deletes a record from Packlink entity table.
     *
    ...
    private function addCondition(QueryCondition $condition, array $indexMap)
    {
        ...
        return $columnName . ' ' . $condition->getOperator()
            . (!\in_array($condition->getOperator(), [Operators::NULL, Operators::NOT_NULL], true)
                ? $this->getConnection()->quote($conditionValue) : ''
            );
    }
    ...
    /**
     * Serializes PacklinkEntity to string.
     *
     * @param Entity $entity PacklinkEntity object to be serialized
     *
